...
const TemplateTriggerRepository = require("./TemplateTriggerRepository");
...
module.exports = {
  async getClientsWithAppointmentsTomorrow(qtyDay, evenType) {
    ...
    try {
      const response = await axios.get(
        "https://api.globalhealth.mv/prod/event/presence-confirmation/pending",
        { params, headers }
      );
      const customers = [];
      if (response?.data?.content.length > 0) {
        ...
        for (const customer of response.data.content) {
          const client = {
            ...
            customFields: [
              {
                id: "164ea54dbf04bacaeb327f5368c49873",
                value: customer.eventDate,
              },
              {
                id: "8faabc197fea7cf8e7b04e5d8fb8c0b0",
                value: customer.eventTime,
              },
              {
                id: "c5a83ce5b026f681d191160e605b357d",
                value: customer.itemAgendamentoId,
              },
              { id: "4b83a59e8c3bddec461cc08c1d56083d", value: "" },
              { id: "5c9d34e4d0942376b2a52a551678ffed", value: customer.id },
              {
                id: "d812476cf9628a594c72353babd6a24d",
                value: customer.serviceName,
              },
              { id: "1c9eceadf8b47b3688687c7aa9e3161d", value: customer.type },
              {
                id: "7fd4f1674105ce9b120119b66f494953",
                value: customer.statusMessage,
              },
              {
                id: "c03f10ddbf4132cd539d728ca3c9334c",
                value: customer.professional,
              },
              { id: "89133f9b80d96b7a9cc954dcc153bb24", value: "" },
              { id: "7f389872954acc1943d1d8043f9faa4a", value: "" },
              { id: "efc78cc4e7199e53d6aee93a9e15b69e", value: "" },
              { id: "8ad99f63602cc779659132f6203a6eb6", value: 0 },
              {
                id: "2202419163a735b276f114d771a7a4c4",
  ...
  async createCustomerOnTable(client) {
    const headers = {
      Authorization:
        "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJib3RfaWQiOjU3MSwiaWF0IjoxNzE3NDQwMjE2fQ.hfp_mKgnDpioTHUzhDI6Zy59sCi05tO-CWDgdLdVwHE",
    };
    ...
    try {
      ...
      if (customers.length > 0) {
        ...
        for (const element of customers) {
          ...
          console.log("==============+++++++++++++++++++++++++++++");
          console.log(element);
          const correctTime = findCustomField(
            element.customFields,
            "8faabc197fea7cf8e7b04e5d8fb8c0b0"
          );
          if (
            (periodo === "manha" &&
              util.timeToMinutes(correctTime) < util.timeToMinutes("13:01")) ||
            (periodo === "tarde" &&
              util.timeToMinutes(correctTime) > util.timeToMinutes("13:00"))
          ) {
            ...
            const params = {
              ...
              status: "aguardando",
              payload_1:
                "CONFIRM_AGENDA_EXAME " +
                findCustomField(
                  element.customFields,
                  "5c9d34e4d0942376b2a52a551678ffed"
                ),
              payload_2:
                "CONFIRM_AGENDA_EXAME_NOSHOW " +
                findCustomField(
                  element.customFields,
                  "5c9d34e4d0942376b2a52a551678ffed"
                ),
              variable_1: element.name,
              variable_2: findCustomField(
                element.customFields,
                "d812476cf9628a594c72353babd6a24d"
              ),
              variable_3: findCustomField(
                element.customFields,
                "164ea54dbf04bacaeb327f5368c49873"
              ),
              variable_4: findCustomField(
                element.customFields,
                "8faabc197fea7cf8e7b04e5d8fb8c0b0"
              ),
            };
        ...
        await TemplateTriggerRepository.updateCampaign(
          campaignId,
          "aguardando"
        );
      }
        ...
        for (const element of customers) {
          ...
          if (
            ...
            const params = {
              ...
              status: "aguardando",
              payload_1:
                "CONFIRM_AGENDA_CONSULTA " +
                findCustomField(
                  element.customFields,
                  "5c9d34e4d0942376b2a52a551678ffed"
                ),
              payload_2:
                "CONFIRM_AGENDA_CONSULTA_NOSHOW " +
                findCustomField(
                  element.customFields,
                  "5c9d34e4d0942376b2a52a551678ffed"
                ),
              ...
              variable_3: findCustomField(
                element.customFields,
                "c03f10ddbf4132cd539d728ca3c9334c"
              ),
              variable_4: findCustomField(
                element.customFields,
                "164ea54dbf04bacaeb327f5368c49873"
              ),
              variable_5: findCustomField(
                element.customFields,
                "8faabc197fea7cf8e7b04e5d8fb8c0b0"
              ),
            };
