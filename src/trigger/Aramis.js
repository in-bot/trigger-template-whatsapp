...
async function triggerRulesAramisTestes() {
    ...
    let comparisonTime = "14:18"; //HORARIO CORRETO
    if (util.timeToMinutes(timeIn24HourFormat) === util.timeToMinutes(comparisonTime) ) { //&& data.getDay() === 5
        ...
        console.log(proximaSegunda)
            ...
            createTriggerAramis(5,0, customer, "03", "ONB_3_EXP_LOJA", 2);
            createTriggerAramis(5,0, customer, "04", "ONB_4_PONTO", 3);
            createTriggerAramis(5,0, customer, "05", "ONB_5_PERFORM", 4);
            createTriggerAramis(5,0, customer, "06", "ONB_6_PILAR1", 7);
            createTriggerAramis(5,0, customer, "07", "ONB_7_HISTORIA", 8);
            createTriggerAramis(5,0, customer, "08", "ONB_8_ARAMIS", 9);
            createTriggerAramis(5,0, customer, "09", "ONB_9_LINHAS", 10);
            createTriggerAramis(5,0, customer, "010", "ONB_10_LIDERANCA", 11);
            createTriggerAramis(5,0, customer, "11", "MENU_SUSTENTABILIDADE_BOTOES", 14);
            createTriggerAramis(14,0, customersCD, "formulario", "ONB_AV_INST_P1", 1); // APENAS MATRIZ OU CD
            createTriggerAramis(14,0, customersMatriz, "formulario", "ONB_AV_INST_P1", 1); // APENAS MATRIZ OU CD
            createTriggerAramis(14,0, customersLojas, "formulario", "ONB_AV_INST_P1", 2); // APENAS LOJAS
    }
}
